...
/**
 * Parent exception type for all recoverable openyolo failures.
 */
public class OpenYoloException extends Exception {
     ...
     */
    public OpenYoloException(String message) {
        super(message);
    }
     ...
     */
    public OpenYoloException(Throwable cause) {
        super(cause);
    }
     ...
     */
    public OpenYoloException(String message, Throwable cause) {
        super(message, cause);
    }
}
